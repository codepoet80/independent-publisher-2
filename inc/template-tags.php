		...
		<header class="entry-header">
			<?php
				if ( is_singular() ) :
					...
					the_title( sprintf( '<h1 class="entry-title"><small><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></small></h1>' );
				endif;
			?>
...
function independent_publisher_2_post_thumbnail() {
	...
	if ( is_singular() ) {
		...
		/* 	Removed by Jon
		* 	3/1/2021
		*	Don't show featured image in blog post unless singular
		*
